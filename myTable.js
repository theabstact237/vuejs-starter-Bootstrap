  ...
  data() {
    return {
      items: [
        ...
        { id: 9, isActive: false, age: 26, name: { first: 'Mitzi', last: 'Navarro' } },
        { id: 10, isActive: false, age: 22, name: { first: 'Genevieve', last: 'Wilson' } },
        { id: 11, isActive: true, age: 38, name: { first: 'John', last: 'Carney' } },
        { id: 12, isActive: false, age: 29, name: { first: 'Dick', last: 'Dunlap' } }
      ],
      fields: [
